...
OnvifServicePtz.prototype.getNodes = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetNodes', soap, (error, result) => {
		if(!error) {
			try {
...
OnvifServicePtz.prototype.getNode = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetNode', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.getConfigurations = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetConfigurations', soap, (error, result) => {
		if(!error) {
			try {
...
OnvifServicePtz.prototype.getConfiguration = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetConfiguration', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.getConfigurationOptions = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetConfigurationOptions', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.getStatus = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetStatus', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.continuousMove = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'ContinuousMove', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.absoluteMove = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'AbsoluteMove', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.relativeMove = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'RelativeMove', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.stop = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'Stop', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.gotoHomePosition = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GotoHomePosition', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.setHomePosition = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetHomePosition', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.setPreset = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetPreset', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.getPresets = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetPresets', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.gotoPreset = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GotoPreset', soap, (error, result) => {
		callback(error, result);
	});
};
...
OnvifServicePtz.prototype.removePreset = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'RemovePreset', soap, (error, result) => {
		callback(error, result);
	});
};
